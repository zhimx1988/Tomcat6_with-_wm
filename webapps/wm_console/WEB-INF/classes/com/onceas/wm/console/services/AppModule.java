package com.onceas.wm.console.services;

import java.io.IOException;

import net.sourceforge.tdojo.TDojoConstants;
...
public class AppModule {
	...
	public static void contributeApplicationDefaults(MappedConfiguration<String, String> configuration) {
		...
		configuration.add(SymbolConstants.SUPPORTED_LOCALES, "zh_CN,zh,en");
	...
	public void contributeTDojoModule(MappedConfiguration<String, String> configuration) {
		configuration.add(TDojoConstants.DEBUG_MODEL, "false");
		// nihilo,soria,tundra
		configuration.add(TDojoConstants.THEME, "soria");
		configuration.add(TDojoConstants.BASE_POJO_FOLDER, "dojo-release-1.3.0-src");
	}
