...
import com.onceas.wm.console.util.MenuNode;
...
//		selectedPage = node.getId();
		selectedPage = ((MenuNode)node).getId();
		
		if("WebAppList".equals(selectedPage)){
			setWebapplist(true);
			//setTitle("WebApplist");
			//setConfig(false);
			//setMonitor(false);
//		}else if("WorkManagerMonitor".equals(selectedPage)){
//			setWebapplist(false);
//			//setConfig(false);
//			//setMonitor(true);
//		}else if("WorkManagerConfig".equals(selectedPage)){
//			setWebapplist(false);
//			//setConfig(true);
//			//setMonitor(false);
		}
			...
			setWebapplist(false);
			//setTitle("WorkManagerMonitor")
		}
		setTitle(selectedPage);
...
//	}
	...
	public void setWebapplist(boolean isWebapplist) {
		this.isWebapplist = isWebapplist;
	}
